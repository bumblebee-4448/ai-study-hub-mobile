...
export const useDocumentStore = create<DocumentStore>((set) => ({
  ...
  recommendedCourses: [
    ...
    },
    {
      ...
      imageUrl:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuAQRBrqwEKJipAcLssgLkUHWnR5fB1zclsjYVfWuNK8U27-KaQ6XJTj2LE_Wz84YnaFOUIuouzVfrj2qfPuOJqDzoJ92cxwV0_3SMRIziq4bQAZ6l_XI-sIG2ZCn8W-NOvkXgxqm2DSotistaUCD-E4DxKjflaESkov0fh6CXXb76lH64OzU3GJ16MoYp-F9qRdYnusBWkf2FWglkuWYRdy24uwoBh60KrLDtosXkP9onuwORXuPyWI5f_wdlhIYKSEiHjetjXAjb0",
    },
  ],

  quickPrompts: [
    { id: "prompt1", label: "Tóm tắt PDF" },
    { id: "prompt2", label: "Tìm bài tập Giải tích" },
    { id: "prompt3", label: "Đề thi ĐH" },
  ],
  ...
  setTrendingDocuments: (documents: Document[]) =>
    set({ trendingDocuments: documents }),
  setRecommendedCourses: (courses: Course[]) =>
    set({ recommendedCourses: courses }),
  setQuickPrompts: (prompts: QuickPrompt[]) => set({ quickPrompts: prompts }),
}));
